...
reference_alpha = {"campylobacter": 0.1626016,
                   "rotavirus": 0.5647084, "borreliosis": 0.9351244}
...
for i, disease in enumerate(diseases):
    ...
    fig.text(
        ...
        box.ymax,
        r"{}".format(
            "campylob." if disease == "campylobacter" else disease),
        fontsize=22,
        ha="center",
        va="bottom")
