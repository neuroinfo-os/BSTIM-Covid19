...
def main(start, county, n_weeks=3, save_plot=False):
    ...
    data = load_daily_data_n_weeks(start, n_weeks, prediction_region, counties)
    ...
    res = load_model(start, n_weeks)
    res_trend = load_trend_model(start, n_weeks)
