...
grid = GridSpec(1, len(diseases), top=0.9, bottom=0.1,
                left=0.07, right=0.97, hspace=0.25, wspace=0.15)
...
for i, disease in enumerate(diseases):
    ...
    fig.text(bbox.x0, bbox.y0 + bbox.height + 0.005,
             r"$\textbf{" + str(i + 1) + "ABC"[i] + r"}$", fontsize=22)
