...
for disease in diseases:
    ...
    grid = GridSpec(1, 2, top=0.9, bottom=0.1, left=0.07,
                    right=0.97, hspace=0.25, wspace=0.15)
    ...
    forestplot(trace, var_labels=[("W_ia", ia_range)],
               var_args=W_ia_args, fig=fig, sp=grid[0])
    forestplot(
        trace,
        var_labels=[
            ("W_t_t",
